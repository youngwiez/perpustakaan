...
$query = "SELECT * FROM pengembalian LIMIT $offset, $limit";
$result = $myConn->query($query);

// Menghitung total data pengembalian
$totalData = $myConn->query("SELECT COUNT(*) as total FROM pengembalian")->fetch_assoc()['total'];
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <br>
          <a href="kembali_tambah.php" class="btn btn-info btn-sm pull-right"><i class="fa fa-plus"></i> &nbsp Tambah Data Pengembalian</a>
        </div>
        <div class="col-sm-6">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a class="btn btn-danger btn-sm" href="kembali_hapus.php?id=<?php echo $d['id_pengembalian'] ?>"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
            <?php
            }
